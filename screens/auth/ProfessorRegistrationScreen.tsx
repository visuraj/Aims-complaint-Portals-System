...
const ProfessorRegistrationScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  const handleRegister = async () => {
    const { fullName, department, email, password, confirmPassword, professorId } = formData;

    if (!fullName || !department || !email || !password || !confirmPassword || !professorId) {
    ...
    setLoading(true);
    try {
      console.log('Registering professor with data:', { fullName, department, email, professorId });
    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.header}>
          <Title style={styles.title}>Professor Registration</Title>
          <Paragraph style={styles.subtitle}>Create your professor account</Paragraph>
        </View>
        ...
        <Card style={styles.card}>
          <Card.Content>
            ...
            <TextInput
              ...
              onChangeText={(value) => handleInputChange('professorId', value)}
              mode="outlined"
              style={styles.input}
            />
